...
function getGroupsForRole(role: AppRole): ActionGroup[] {
  if (role === "superadmin") {
    return [
      ...
      { title: "Comptes & accès", items: [
        { label: "Gérer les administrateurs", icon: ShieldCheck, to: "/dashboard/administration/admins", hint: "Créer / modifier / attribuer des entreprises" },
      ]},
